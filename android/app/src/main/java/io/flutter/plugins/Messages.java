...
public class Messages {
  ...
  public static final class MessageData {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(name, that.name) && Objects.equals(description, that.description) && data.equals(that.data);
    }
  ...
  public interface QuantumHostApi {
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @Nullable QuantumHostApi api) {
      setUp(binaryMessenger, "", api);
    }
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable QuantumHostApi api) {
      messageChannelSuffix = messageChannelSuffix.isEmpty() ? "" : "." + messageChannelSuffix;
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.quantum.QuantumHostApi.getHostLanguage" + messageChannelSuffix, getCodec());
        if (api != null) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.quantum.QuantumHostApi.add" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.quantum.QuantumHostApi.sendMessage" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
